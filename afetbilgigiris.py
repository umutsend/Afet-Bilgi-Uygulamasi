iller={
"adana":["--- ADANA ---\nDeprem riski =  2. Derece\n1900-2013 arası sel felaketi sayısı = 1-4\n1900-2013 Çığ felaketi sayısı = 1-5 \n1900-2013 arası heyelan sayı aralığı = 1-10 "],
"adıyaman":["--- ADIYAMAN ---\nDeprem riski = 1. Derece\n1900-2013 arası sel felaketi sayısı = 1-4 \n 1900-2013 Çığ felaketi sayısı  =  5-10 \n1900-2013 arası heyelan sayı aralığı = 20-30 "],
"afyonkarahisar":["---AFYONKARAHİSAR ---\nDeprem riski = 2. Derece\n 1900-2013 arası sel felaketi sayısı = 1-4 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı = 1-10 "],
"ağrı":["--- AĞRI ---\nDeprem riski = 2. Derece\n 1900-2013 arası sel felaketi sayısı = 10-20 \n 1900-2013 Çığ felaketi sayısı = 5-10 \n1900-2013 arası heyelan sayı aralığı =  10-20"],
"amasya=":["--- AMASYA ---\nDeprem riski = 1. Derece\n 1900-2013 arası sel felaketi sayısı = 10-20 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı =  20-30"],
"ankara":["--- ANKARA ---\nDeprem riski = 3. Derece\n 1900-2013 arası sel felaketi sayısı = 5-10 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı =  10-20"],
"antalya":["--- ANTALYA ---\nDeprem riski = 2. Derece\n 1900-2013 arası sel felaketi sayısı = 1-5 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı =  1-10"],
"artvin":["--- ARTVİN ---\nDeprem riski = 4. Derece\n 1900-2013 arası sel felaketi sayısı = 1-5 \n 1900-2013 Çığ felaketi sayısı = 20-25 \n1900-2013 arası heyelan sayı aralığı =  50"],
"aydın":["--- AYDIN ---\nDeprem riski = 1. Derece\n 1900-2013 arası sel felaketi sayısı = 1-5 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı =  1-10"],
"balıkesir":["--- BALIKESİR ---\nDeprem riski = 1. Derece\n 1900-2013 arası sel felaketi sayısı = 1-4 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı =  1-10"],
"bilecik":["--- BALIKESİR ---\nDeprem riski = 1. Derece\n 1900-2013 arası sel felaketi sayısı = 1-4 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı =  1-10"],
"bingöl":["--- BİNGÖL ---\nDeprem riski = 1. Derece\n 1900-2013 arası sel felaketi sayısı = 10-20 \n 1900-2013 Çığ felaketi sayısı = 25-30 \n1900-2013 arası heyelan sayı aralığı =  40-50"],
"bitlis":["--- BİTLİS ---\nDeprem riski = 1. Derece\n 1900-2013 arası sel felaketi sayısı = 10-20 \n 1900-2013 Çığ felaketi sayısı = 30 \n1900-2013 arası heyelan sayı aralığı =  20-30"],
"bolu":["--- BOLU ---\nDeprem riski = 1. Derece\n 1900-2013 arası sel felaketi sayısı = 1-4 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı =  1-10"],
"burdur":["--- BURDUR ---\nDeprem riski = 1. Derece\n 1900-2013 arası sel felaketi sayısı = 1-4 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı =  0"],
...
"edirne":["--- EDİRNE ---\nDeprem riski = 4. Derece\n 1900-2013 arası sel felaketi sayısı = 1-4 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı =  1-10"],
"elazığ":["--- ELAZIĞ ---\nDeprem riski = 2. Derece\n 1900-2013 arası sel felaketi sayısı = 0 \n 1900-2013 Çığ felaketi sayısı = 10-15 \n1900-2013 arası heyelan sayı aralığı =  10-20"],
"erzincan":["--- ERZİNCAN ---\nDeprem riski = 1. Derece\n 1900-2013 arası sel felaketi sayısı = 5-9 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı =  30-40"],
"erzurum":["--- ERZURUM ---\nDeprem riski = 2. Derece\n 1900-2013 arası sel felaketi sayısı = 30-40 \n 1900-2013 Çığ felaketi sayısı = 15-20 \n1900-2013 arası heyelan sayı aralığı =  50"],
"eskişehir":["--- ESKİŞEHİR ---\nDeprem riski = 2. Derece\n 1900-2013 arası sel felaketi sayısı = 0 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı = 0 "],
"gaziantep":["--- GAZİANTEP ---\nDeprem riski = 4. Derece\n 1900-2013 arası sel felaketi sayısı = 1-4 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı = 0 "],
"giresun":["--- GİRESUN ---\nDeprem riski = 3. Derece\n 1900-2013 arası sel felaketi sayısı = 0 \n 1900-2013 Çığ felaketi sayısı = 1-5 \n1900-2013 arası heyelan sayı aralığı =  40-50"],
"gümüşhane":["--- GÜMÜŞHANE ---\nDeprem riski = 3. Derece\n 1900-2013 arası sel felaketi sayısı = 5-9 \n 1900-2013 Çığ felaketi sayısı = 1-5 \n1900-2013 arası heyelan sayı aralığı = 20-30 "],
...
"hatay":["--- HATAY ---\nDeprem riski = 1. Derece\n 1900-2013 arası sel felaketi sayısı = 0 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı =  1-10"],
"ısparta":["--- ISPARTA ---\nDeprem riski = 1. Derece\n 1900-2013 arası sel felaketi sayısı = 1-4 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı =  1-10"],
"mersin":["--- MERSİN ---\nDeprem riski = 4. Derece\n 1900-2013 arası sel felaketi sayısı = 10-19 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı =  1-10"],
"istanbul":["--- İSTANBUL ---\nDeprem riski = 1. Derece\n 1900-2013 arası sel felaketi sayısı = 1-4 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı =  1-10"],
"izmir":["--- İZMİR ---\nDeprem riski = 1. Derece\n 1900-2013 arası sel felaketi sayısı = 1-4 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı =  1-10"],
"kars":["--- KARS ---\nDeprem riski = 2. Derece\n 1900-2013 arası sel felaketi sayısı = 1-4 \n 1900-2013 Çığ felaketi sayısı = 1-5 \n1900-2013 arası heyelan sayı aralığı =  1-10"],
"kastamonu":["--- KASTAMONU ---\nDeprem riski = 1. Derece\n 1900-2013 arası sel felaketi sayısı =0  \n 1900-2013 Çığ felaketi sayısı = 1-5 \n1900-2013 arası heyelan sayı aralığı =  50"],
...
"şanlıurfa":["--- ŞANLIURFA ---\nDeprem riski = 4. Derece\n 1900-2013 arası sel felaketi sayısı = 1-4 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı =  1-10"],
"uşak":["--- UŞAK ---\nDeprem riski = 2. Derece\n 1900-2013 arası sel felaketi sayısı = 1-4 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı =  0"],
"van":["--- VAN ---\nDeprem riski = 2. Derece\n 1900-2013 arası sel felaketi sayısı =  \n 1900-2013 Çığ felaketi sayısı = 15-20 \n1900-2013 arası heyelan sayı aralığı = 10-20 "],
"yozgat":["--- YOZGAT ---\nDeprem riski = 3. Derece\n 1900-2013 arası sel felaketi sayısı =  0\n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı = 1-10 "],
"zonguldak":["--- ZONGULDAK ---\nDeprem riski = 2. Derece\n 1900-2013 arası sel felaketi sayısı = 1-4  \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı = 1-10 "],
"aksaray":["--- AKSARAY ---\nDeprem riski = 5. Derece\n 1900-2013 arası sel felaketi sayısı = 1-4 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı =  1-10"],
"bayburt":["--- BAYBURT ---\nDeprem riski = 3. Derece\n 1900-2013 arası sel felaketi sayısı = 1-4 \n 1900-2013 Çığ felaketi sayısı =  0\n1900-2013 arası heyelan sayı aralığı =  1-10"],
"karaman":["--- KARAMAN ---\nDeprem riski = 5. Derece\n 1900-2013 arası sel felaketi sayısı = 0 \n 1900-2013 Çığ felaketi sayısı = 0 \n1900-2013 arası heyelan sayı aralığı =  1-10"],
"kırıkkale":["--- KIRIKKALE ---\nDeprem riski = 1. Derece\n 1900-2013 arası sel felaketi sayısı = 1-4 \n 1900-2013 Çığ felaketi sayısı =  0\n1900-2013 arası heyelan sayı aralığı =  1-10"],
"batman":["--- BATMAN ---\nDeprem riski = 2. Derece\n 1900-2013 arası sel felaketi sayısı = 1-4 \n 1900-2013 Çığ felaketi sayısı = 1-5 \n1900-2013 arası heyelan sayı aralığı =  1-10"],
